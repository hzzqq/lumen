...
ok('presetToParams 字段数 74(含 invert/border/bright/duotone/vibrance/mono/tint/balance/bleach/fade/splittone/highlights/glow/solarize/expose/threshold/crossprocess/falsecolor/gradientmap/pastel/infrared/radial/swirl/night/emboss/edge/pixelate/rgbshift)', (()=>{ const m = main.match(/function presetToParams\(p\)\{[\s\S]*?\n\}/); const f = eval('(' + m[0] + ')'); return Object.keys(f({})).length === 74; })());
