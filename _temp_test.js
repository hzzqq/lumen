...
ok(/temp: Math\.max\(-1, Math\.min\(1, num\('temp', 0\)\)\)/.test(main), 'deserializeScene reads temp');
ok(/temp: Math\.max\(-1, Math\.min\(1, num\(p\.temp, 0\)\)\)/.test(main), 'presetToParams reads temp');
