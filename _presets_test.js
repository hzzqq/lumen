...
// ---- presetToParams 归一化（类型守卫）----
{
  ...
  ok('presetToParams 返回 134 字段（含 fogGlow 雾光柱/sunSoftOn 太阳软阴影/sunNeeOn 太阳直射焦散/太阳/金属粗糙度/黄金比/雾颜色/FOV/背景渐变/调试视图/萤火虫钳制/饱和度/对比度/锐化/抖动/色温/色相/复古褐调/色调分层/电影黑边/CRT扫描线/反相负片/画面边框/亮度增益/双色调/自然饱和度/去色灰度/色调染色/色彩平衡/漂白旁路/褪色/分离色调/高光压缩/柔光/色调分离/曝光/阈值二值化/交叉冲印/伪彩映射/渐变映射/粉彩/红外假彩/径向色相/漩涡色相/夜视绿/浮雕/边缘检测/像素化/RGB偏移/半调网点/三色染印/油画/Lomo/漏光/波形畸变/彩色噪点/万花筒/水波纹/色相分层/暗部提升/高光饱和/鱼眼/点光源/故障艺术/泛光阈值/柔光阈值/颗粒缩放/增强扫描线/调色/边缘检测新/色调分层新/老照片新/鱼眼新/交叉影线/镜头畸变）', Object.keys(s).length === 134);
  ok('fogGlow 预设未声明时默认 8（光柱中档）', s.fogGlow === 8);
  ok('sunNeeOn 预设未声明时默认 true（焦散不被预设静默关闭）', s.sunNeeOn === true);
  ok('sunSoftOn 预设未声明时默认 false（软阴影性能保守）', s.sunSoftOn === false);
